...
<div id="project">
    <table>
        <tr>
          <td colspan="4" class="grand service" style="text-align:center;">Periodo: {{ $direct_contribution->period() }}  </td>
        </tr>
      <tr>
        <td class="grand service" style="text-align:center;" >Total a Pagar</td>
        <td class="grand service" style="text-align:center;">Literal</td>
      ...
      <tr>
        ...
        <th class="info" style="text-align:center;">{{ $voucher->total }}</th>
